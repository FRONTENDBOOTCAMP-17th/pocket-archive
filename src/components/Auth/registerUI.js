export function Register() {
  return `
    <main class="w-screen min-h-screen flex flex-col items-center justify-center gap-5" style="background: linear-gradient(135deg, #FEF2F2 0%, #FFF 50%, #FFF7ED 100%)">
      ...
      <!-- 커스텀 에러 모달 -->
      <div id="register-modal" class="fixed inset-0 z-50 items-center justify-center hidden">
        <div id="register-modal-overlay" class="absolute inset-0 bg-black/40 backdrop-blur-sm"></div>
        <div class="relative bg-white rounded-2xl shadow-xl"
          ...
          <div>
            <h3 id="register-modal-title" class="text-lg font-black text-slate-900">알림</h3>
            <p id="register-modal-desc" class="text-sm text-slate-400" style="margin-top:4px;"></p>
          </div>
          <button id="register-modal-confirm"
      ...
      <div class="bg-white rounded-xl border-t-8 border-b-8 border-[#00BBA7] shadow-[0_8px_32px_rgba(0,187,167,0.15)] flex flex-col items-start gap-6 w-md max-[501px]:w-[calc(100vw-32px)] max-[501px]:h-auto max-[501px]:px-5 max-[501px]:pb-6" style="padding:32px;">
        ...
        <form name="registerForm" class="w-full flex flex-col gap-4">
          <!-- nickname -->
          <div style="display:flex; min-height:96px; flex-direction:column; align-items:flex-start; gap:8px; flex-shrink:0; align-self:stretch;">
            ...
            <div style="display:flex; flex-direction:row; align-items:center; gap:8px; width:100%;">
              <input
                ...
                class="w-full h-12 bg-[#f4faf9] border border-[#d0eeea] rounded-lg text-sm text-[#1a3a35] placeholder-[#aac8c3] outline-none focus:border-[#00BBA7] transition-colors" style="padding-left: 12px; padding-right: 16px;"
              />
           ...
           <p id="nickname-check-msg" class="hidden text-xs" style="margin-top: -4px;"></p>
          </div>
          ...
          <div style="display:flex; min-height:96px; flex-direction:column; align-items:flex-start; gap:8px; flex-shrink:0; align-self:stretch;">
            ...
            <p id="id-check-msg" class="hidden text-xs" style="margin-top: -4px;"></p>
          </div>
